...
public class DeleteNoticeActivity extends AppCompatActivity {
    ...
    private void getNotice() {
        reference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) { // Rename the inner variable to dataSnapshot
                list = new ArrayList<>();
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){ // Use dataSnapshot here
